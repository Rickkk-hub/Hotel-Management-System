    ...
    <aside className="fixed top-0 left-0 h-full w-64 lg:sticky bg-white shadow flex flex-col justify-between">
      ...
      <div>
        ...
        <nav className="mt-4 px-3 flex flex-col gap-2">
          <SidebarItem icon={<Hotel className="text-green-500" size={18} />} label="Overview" href="/GuestDashboard" />
          <SidebarItem icon={<CalendarDays className="text-violet-500" size={18} />} label="My Bookings" href="/GetBooking" />
          <SidebarItem icon={<BedDouble className="text-blue-500" size={18} />} label="Book a Room" href="/GetRoom" />
          <SidebarItem icon={<Settings className="text-red-500" size={18} />} label="Profile Settings" href="/GetProfile" />
        </nav>
      </div>
